...
nonisolated func flagFromCallsignPrefix(_ callsign: String) -> String? {
    ...
    if clean.hasPrefix("BV") || clean.hasPrefix("BM") || clean.hasPrefix("BN") || clean.hasPrefix("BO") || clean.hasPrefix("BP") || clean.hasPrefix("BQ") || clean.hasPrefix("BU") || clean.hasPrefix("BW") || clean.hasPrefix("BX") { return "🇹🇼" }
    if clean.hasPrefix("BY") || clean.hasPrefix("BA") || clean.hasPrefix("BD") || clean.hasPrefix("BG") || clean.hasPrefix("BH") || clean.hasPrefix("BI") || clean.hasPrefix("BJ") || clean.hasPrefix("BL") || clean.hasPrefix("BT") { return "🇨🇳" }
