    ...
    private var logTable: some View {
        Group {
            ...
            helpSection("Columns and Stored Data") {
                ...
                HelpDefinition(icon: "flag.2.crossed", title: "Country names stay consistent", text: "YAAM recognizes formal names, capitalization differences, and common legacy spellings as the same country. For example, Federal Republic of Germany becomes Germany, ITALY becomes Italy, and Bosnia-Herzegovin becomes Bosnia and Herzegovina. Distinct DXCC entities such as Crete, European Russia, and Asiatic Russia remain separate.", color: .green)
            }
